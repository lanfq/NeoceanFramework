...
{
    public class NeoObjectContext : DbContext, IDbContext
    {
        public NeoObjectContext(string nameOrConnectionString)
        ...
        protected virtual TEntity AttachEntityToContext<TEntity>(TEntity entity) where TEntity : AggregateRoot, new()
        {
        ...
        public new IDbSet<TEntity> Set<TEntity>() where TEntity : AggregateRoot
        {
